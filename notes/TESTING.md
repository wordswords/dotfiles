...
1. On the top level we have exploratory testing. This should be a tiny fraction of
...
2. On the second level we have UI tests. These are scripted, automated, UI tests
...
3. On the third level we have API or integration tests. These explore the integrations
...
4. On the fourth level, we have unit tests. These test 'atoms' of development code.
